...
<section class="hero position-relative text-white text-center d-flex align-items-center justify-content-center"
         style="background: linear-gradient(rgba(216, 221, 140, 0.23), rgba(0, 0, 0, 0)), url('/apteka/public/uploads/hero.jpg') center/cover no-repeat; height: 70vh; min-height: 520px;">
    <div class="container">
        ...
        <div class="brand-slide-footer">
            <div class="container">
                ...
                <div class="brand-slide-products">
                    ...
                    <a href="/apteka/public/product.php?id=<?= $p['id'] ?>" class="brand-mini-card">
...
<main class="container pb-5">
    <?php if ($search !== '' && empty($products)): ?>
        <div class="alert alert-light border text-center py-4 rounded-3">
            Ничего не найдено по запросу: <strong>"<?= htmlspecialchars($search) ?>"</strong>
        </div>
    <?php endif; ?>
                ...
                <div class="card h-100 d-flex flex-column position-relative overflow-hidden"
                    ...
                    <a href="product.php?id=<?= $p['id'] ?>" class="text-decoration-none text-dark d-flex flex-column flex-grow-1">
                        <img src="<?= htmlspecialchars($p["image"] ?: 'https://via.placeholder.com/600') ?>"
                             ...
                             alt="<?= htmlspecialchars($p['name']) ?>" loading="lazy">
                        <div class="card-body d-flex flex-column flex-grow-1" style="padding:1rem 1rem 0.5rem;">
                            <h5 class="card-title mb-1" style="font-size:.88rem;font-weight:600;line-height:1.35;">
                    ...
                    <div style="padding:.75rem 1rem 1rem;">
                        ...
                        <?php else: ?>
                            <a href="add_to_cart.php?id=<?= $p['id'] ?>&redirect=index.php"
                               class="btn btn-outline-custom w-100" style="height:42px;display:flex;align-items:center;justify-content:center;font-size:.85rem;">
                                В корзину
                            </a>
                        <?php endif; ?>
                    </div>
