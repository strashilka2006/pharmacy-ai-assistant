...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["action"]) && $_POST["action"] === "send_code") {
    ...
    $message = "Ваш код: <b>$code</b><br>Действует 10 минут.";
    $headers  = "MIME-Version: 1.0\r\n";
    $headers .= "Content-type: text/html; charset=utf-8\r\n";
    $headers .= "From: noreply@твойсайт.ru\r\n";
...
<main style="background:#f8fef3;min-height:calc(100vh - 58px);">
    <div class="reg-wrap">
        ...
        <div style="display:flex;flex-direction:column;gap:10px;margin-bottom:8px;">
            <button type="button" class="social-btn google-btn" onclick="startGoogleLogin()">
            ...
            <div id="g_id_onload"
                data-client_id="857644478861-nq01jaafai2ibhq1q7tkhn6a18hsvrn4.apps.googleusercontent.com"
...
window.onload = function () {
    if (typeof google !== 'undefined') {
        google.accounts.id.initialize({
            client_id: '857644478861-nq01jaafai2ibhq1q7tkhn6a18hsvrn4.apps.googleusercontent.com',
