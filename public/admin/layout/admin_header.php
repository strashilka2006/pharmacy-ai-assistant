    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav ms-auto align-items-center" style="gap:2.25rem;">
                <li class="nav-item">
                    <a class="nav-link" href="<?= BASE_URL ?>/personal.php" style="color:#333;font-size:.9rem;padding:.4rem 1rem;">ПРОФИЛЬ</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= BASE_URL ?>/cart.php" style="color:#333;font-size:.9rem;padding:.4rem 1rem;">КОРЗИНА</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link fw-600" href="<?= BASE_URL ?>/admin/products.php" style="color:#a6d175;font-size:.9rem;padding:.4rem 1rem;">АДМИНКА</a>
                </li>
